...
export type { IROUTER } from "./contracts/Interfaces/IThorchainRouter.sol/IROUTER";
export { IROUTER__factory } from "./factories/contracts/Interfaces/IThorchainRouter.sol/IROUTER__factory";
